...
site_url = "https://www.snlo.app"  # 需修改为自己的网址
username = "snlo" # GitHub 用户名，需修改为自己的用户名
token = "f8f3a4bfacfe99414dce9489f88827aaf0bc285b"   # GitHub Token，在账户设置中申请
repo_name = "snlo-issues"  # 存放 issues，需修改为自己的仓库名
